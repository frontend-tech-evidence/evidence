import { calcularCostoImplementacion } from '../../dist/pages/Cotizador/core/queries/CostoPaquete.js';
class ThElement extends HTMLElement {
    constructor() {
        super();
            ...
            <div class="flex flex-col items-center gap-y-1 px-4">
                ...
                <div class="mt-4 flex flex-col items-center gap-y-2">
                    ...
                    <div class="flex flex-row items-center text-gray-900 dark:text-white">
                        <span id="spanPriceGrowRenew"
                            class="spanPrecioSegundoAnio text-lg font-bold leading-6 text-black"></span>
                        <span class="spanMoneda ml-1 text-sm leading-6 text-gray-600"></span>
                        <span class="ml-1 text-sm leading-6 text-gray-600">
                            <span class="spanPagos"> </span></span>
                    </div>
                    ...
                    <div class="mt-3 flex flex-col gap-y-2">
                        <a id="btnCotizarGrow" href="http://127.0.0.1:8000/contratar-paquete"
                        ...
                        <a id="btnContratarGrow" href="http://127.0.0.1:8000/contratar-paquete"
...
if ('customElements' in window) {
    customElements.define('th-element', ThElement);
}
//# sourceMappingURL=ThElement.js.map