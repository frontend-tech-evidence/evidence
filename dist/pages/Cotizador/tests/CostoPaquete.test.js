 ...
 */
import { calcularCostoImplementacion, calcularCostoMembresia, calcularCostoTimbres, calcularCostoUsuario, calcularCostoPrimerAño, } from '../core/CostoPaquete.js';
...
describe('Calcular el costo total del paquete', () => {
    ...
    describe('🎨 Paquete Manufacturing', () => {
        it('Todo en meses y en dolares', () => {
            ...
            const costoTimbres = calcularCostoTimbres(100, 100, 1);
            const costoUsuarios = calcularCostoUsuario(1, 1, 829, true, 499, 49);
            expect(cambiarDivisa(calcularCostoPrimerAño(costoImplementacion, costoMembresia, costoTimbres, costoUsuarios), 16)).toBe(1442);
        });
    });
});
