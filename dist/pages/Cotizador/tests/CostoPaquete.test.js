 ...
 */
import { calcularCostoImplementacion, calcularCostoMembresia, calcularCostoTimbres, calcularCostoUsuario, calcularCostoPrimerAño, calcularCostoConCambioDivisa, } from '../core/CostoPaquete.js';
describe('Calcular el costo total del paquete', () => {
    ...
    describe('🎨 Paquete Grow', () => {
        it('Todo en meses', () => {
            ...
            //     costoUsuarios
            // )
            calcularCostoPrimerAño(costoImplementacion, costoMembresia, costoTimbres, costoUsuarios)).toBe(5440);
        });
    });
    describe('🎨 Paquete Manufacturing', () => {
        it('Todo en meses y en dolares', () => {
            const costoImplementacion = calcularCostoImplementacion(19000, 49000, 29000, 10, true);
            const costoMembresia = calcularCostoMembresia(14990, 1, true);
            const costoTimbres = calcularCostoTimbres(100, 100, 1);
            const costoUsuarios = calcularCostoUsuario(1, 1, 829, true, 499, 49);
            expect(calcularCostoConCambioDivisa(calcularCostoPrimerAño(costoImplementacion, costoMembresia, costoTimbres, costoUsuarios), 16)).toBe(1442);
        });
    });
});
