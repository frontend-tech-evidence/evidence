...
import { erpPrices } from './data/prices.js'
...
if (parent) {
  ...
  function calculatePrice(
    ...
    if (packageType === 'manufacturing' || packageType === 'enterprise') {
      if (numUsuarios > numUsuariosLimites) {
        ...
        let costoUsuariosExtras = numUsuariosExtras * precioUsuarioDespuesLimite
    ...
    if (tasaDeCambio === 'usd') {
      ...
      precioTotalSegundoAño = Math.floor(precioTotalSegundoAño / precioDolar)
      costoCapacitacionFinal = Math.floor(costoCapacitacionFinal / precioDolar)
      ...
      costoUsuariosFinales = Math.floor(costoUsuariosFinales / precioDolar)
  ...
  function updatePrices(erpPrices) {
    ...
    const precioTotal = calculatePrice(
      ...
      erpPrices.categories.servicios[paqueteGanador].costosExtra.costoMigracion, // costoMigracion
